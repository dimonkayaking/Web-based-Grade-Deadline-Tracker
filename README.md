...
- [2. Функциональные требования](#2-функциональные-требования)
  - [2.1. Обязательные функции](#21-обязательные-функции)
    ...
    - [2.1.7. Страница деталей предмета](#217-страница-деталей-предмета)
    - [2.1.8. Создание задания](#218-создание-задания)
    - [2.1.9. Редактирование задания](#219-редактирование-задания)
    - [2.1.10. Удаление задания](#2110-удаление-задания)
    - [2.1.11. Создание оценки](#2111-создание-оценки)
    - [2.1.12. Редактирование оценки](#2112-редактирование-оценки)
    - [2.1.13. Удаление оценки](#2113-удаление-оценки)
  - [2.2. Необязательные функции](#22-необязательные-функции)
    - [2.2.1. Вкладка "Календарь"](#221-вкладка-календарь)
    - [2.2.2. Создание задания через календарь](#222-создание-задания-через-календарь)
    - [2.2.3. Редактирование задания через календарь](#223-редактирование-задания-через-календарь)
    - [2.2.4. Удаление задания через календарь](#224-удаление-задания-через-календарь)
...
- [7. Примерная структура проекта](#7-примерная-структура-проекта-для-стандартного-варианта)
  - [7.1. Общая структура](#71-общая-структура)
  - [7.2. Структура фронтенда](#72-структура-фронтенда-react)
  - [7.3. Структура бэкенда](#73-структура-бэкенда-python-fastapi--пример)
- [8. Приложения](#8-приложения)
  - [8.1. Схема базы данных (ER-диаграмма)](#81-схема-базы-данных-er-диаграмма)
  - [8.2. Макеты интерфейса (Figma)](#82-макеты-интерфейса-figma)
  - [8.3. Скриншоты экранов](#83-скриншоты-экранов)
  - [8.4. Спецификация API (Swagger/OpenAPI)](#84-спецификация-api-swaggeropenapi)
