...
**6.4.3. CSV**
- **Назначение:** импорт табличных данных, открывается в Excel, компактный размер
- **Разделитель:** запятая (`,`) или точка с запятой (`;`) в зависимости от локали
- **Кодировка:** UTF-8
- **Особенности:** каждая таблица импортируется из отдельного CSV-файла

**6.4.4. Поддерживаемые сущности для миграции**

| Сущность | Экспорт | Импорт |
|----------|:-------:|:------:|
| Предметы | ✅ (XLSX) | ✅ (XLSX, CSV) |
| Оценки предмета | ✅ (XLSX) | ✅ (XLSX, CSV) |
