...
- Экспорт и импорт данных поддерживаются в форматах **XLSX и CSV**
- Автоматическая интеграция с внешними системами (Дневник.ру, БРС УрФУ) через API **не реализуется** на текущем этапе. Пользователь может вручную выгрузить данные из внешней системы в CSV и импортировать их в трекер
